...
with st.sidebar:
    ...
    st.info(
        "It aims for truthful, source-grounded answers. If evidence is weak or incomplete, it will say so "
...
st.caption(
    "Ask for financial metrics or company details. The app fetches live public documents, ingests them, "
